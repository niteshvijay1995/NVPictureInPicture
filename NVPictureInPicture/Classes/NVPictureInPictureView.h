...
@protocol NVPictureInPictureViewDelegate;

@interface NVPictureInPictureView : UIView

/**
 @property  delegate
 @abstract  The receiver's delegate.
 */
@property (nonatomic, weak) id<NVPictureInPictureViewDelegate> delegate;
 ...
 */
@protocol NVPictureInPictureViewDelegate <NSObject>

@optional

/*!
 @method    pictureInPictureViewControllerWillStartPictureInPicture:
 @param    pictureInPictureView
 The Picture in Picture view controller.
 @abstract  Delegate can implement this method to be notified when Picture in Picture will start.
 */
- (void)pictureInPictureViewWillStartPictureInPicture:(NVPictureInPictureView *)pictureInPictureView;

/*!
 @method    pictureInPictureViewDidStartPictureInPicture:
 @param    pictureInPictureView
 The Picture in Picture controller.
 @abstract  Delegate can implement this method to be notified when Picture in Picture did start.
 */
- (void)pictureInPictureViewDidStartPictureInPicture:(NVPictureInPictureView *)pictureInPictureView;

/*!
 @method    pictureInPictureViewWillStopPictureInPicture:
 @param    pictureInPictureView
 The Picture in Picture controller.
 @abstract  Delegate can implement this method to be notified when Picture in Picture will stop.
 */
- (void)pictureInPictureViewWillStopPictureInPicture:(NVPictureInPictureView *)pictureInPictureView;

/*!
 @method    pictureInPictureViewDidStopPictureInPicture:
 @param    pictureInPictureView
 The Picture in Picture controller.
 @abstract  Delegate can implement this method to be notified when Picture in Picture did stop.
 */
- (void)pictureInPictureViewDidStopPictureInPicture:(NVPictureInPictureView *)pictureInPictureView;
